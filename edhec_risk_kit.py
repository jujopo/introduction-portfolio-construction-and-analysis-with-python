...
def semideviation(r:pd.Series or pd.DataFrame) -> float or pd.Series:
    """
...
def semideviation3(r:pd.Series or pd.DataFrame) -> float or pd.Series:
    """
    Returns the semideviation aka negative semideviation of r
    r must be a Series or a DataFrame
    """
...
def skewness(r) -> float or pd.Series:
    '''
    Alternative to scipy.stats.skew(). Computes the skewness of the supplied Series or DataFrame
...
def kurtosis(r) -> float or pd.Series:
    '''
    Alternative to scipy.stats.kurtosis(). Computes the kurtosis of the supplied Series or DataFrame
    Returns a float or a Series
    '''
...
def plot_ef2(n_points, er, cov, figsize = (8,8), style = '-'):
    '''
...
def plot_ef(n_points, er, cov, show_cml = False, show_ew = False, show_gmv = False, \
    riskfree_rate = 0, figsize = (8,8), style = '-'):
    '''
